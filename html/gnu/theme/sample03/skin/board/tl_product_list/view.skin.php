...
//lightslider
add_stylesheet('<link rel="stylesheet" href="' . $board_skin_url . '/css/lightslider.min.css">', 0);
            ...
            <div id="img-gallery-wrapper">
                <ul id="img-gallery">
                    ...
                    for ($i = 0; $i < $view['file']['count']; $i++) {
                        ...
                        $thumb_600_file = thumbnail($view['file'][$i]['file'], $st_path, $st_path, 600, 0, false);
                    ?>
                        ...
                        <img src="<?=$view['file'][$i]['path']?>/<?=$thumb_600_file?>" style="width:100%;">
                        </a>
                        </li>
                    <?php
                    }
