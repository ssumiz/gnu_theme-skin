...
<nav class="navbar fixed-top navbar-expand-lg navbar-white fixed-top" id= "jh_gnb">
  <div class="container">

	<!-- 메인 로고  -->

	<?php
		echo latest('pic_list','logo',1,100);
	?>
	
	<!-- <img src="<?php echo G5_THEME_URL?>/img/logo.png" class="logo"></a> -->
	<!-- <span>
